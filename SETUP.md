...
This guide will walk you through setting up the MNIST training pipeline and dashboard from scratch.
...
- `images/` folder - Generated visualizations
...
- For GPU acceleration, ensure PyTorch CUDA is installed (local-development)
